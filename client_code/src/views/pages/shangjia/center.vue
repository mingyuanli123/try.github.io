			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						...
						<el-col :span="24">
							<el-form-item prop="dianputupian" label="店铺图片">
								<uploads
									action="file/upload" 
									tip="请上传店铺图片" 
									:limit="1" 
									style="width: 100%;text-align: left;"
									:fileUrls="userForm.dianputupian?userForm.dianputupian:''" 
						...
						<el-col :span="8">
							<el-form-item prop="jingyingdizhi" label="经营地址">
								<el-input class="list_inp" v-model="userForm.jingyingdizhi" placeholder="经营地址" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="主要经营" prop="zhuyaojingying">
								<el-input class="list_inp" v-model="userForm.zhuyaojingying" placeholder="主要经营" type="textarea"
								/>
							</el-form-item>
						</el-col>
					</el-row>
...
<script setup>
	...
	const updateSession = () => {
		userFormRef.value.validate((valid)=>{
			if(valid){
				if(userForm.value.dianputupian!=null){
					userForm.value.dianputupian = userForm.value.dianputupian.replace(new RegExp(context?.$config.url,"g"),"");
				}
				context?.$http({
					url: `${tableName}/update`,
					method: 'post',
