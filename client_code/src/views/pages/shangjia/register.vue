	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					...
					<div class="list_file_list">
						<uploads
							...
							:fileUrls="registerForm.dianputupian?registerForm.dianputupian:''" 
				...
				<div class="list_item">
					<div class="list_label">经营地址：</div>
					<input class="list_inp"
					 v-model="registerForm.jingyingdizhi" 
					 placeholder="请输入经营地址"
					 type="text"
					 />
				</div>
...
<script setup>
    ...
    const dianputupianUploadSuccess=(fileUrls)=> {
        registerForm.value.dianputupian = fileUrls;
    }
	// 多级联动参数
	//注册按钮
	const handleRegister = () => {
		...
		if(registerForm.value.dianputupian!=null){
			registerForm.value.dianputupian = registerForm.value.dianputupian.replace(new RegExp(context?.$config.url,"g"),"");
		}
