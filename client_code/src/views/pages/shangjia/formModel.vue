	...
	<div class="app-contain" :style='{"padding":"0 12%","margin":"10px auto 20px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">经营地址</div>
					<div  class="info_text" >{{detail.jingyingdizhi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">主要经营</div>
					<div  class="info_text" >{{detail.zhuyaojingying}}</div>
				</div>
				<div class="btn_view">
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			bannerList.value = res.data.data.dianputupian?res.data.data.dianputupian.split(','):[]
