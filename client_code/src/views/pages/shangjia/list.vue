			...
			<div class="data_box">
				<div class="data_view">
					<div class="data_item" v-for="(item,index) in list" :key="index" @click.stop="detailClick(item.id)" >
						<div class="data_img_box" v-if="item.dianputupian && item.dianputupian.substr(0,4)=='http'" @click.stop="preViewClick(item.dianputupian)">
							<el-image class="data_img" :src="item.dianputupian" fit="cover"></el-image>
						</div>
						<div class="data_img_box" v-else @click.stop="preViewClick($config.url+item.dianputupian.split(',')[0])">
							<el-image class="data_img" :src="item.dianputupian?$config.url + item.dianputupian.split(',')[0]:''"
								fit="cover"></el-image>
						</div>
