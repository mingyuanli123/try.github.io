		...
		<div class="home_box">
			...
			<div class="recomList_view">
				...
				<div class="recommend_list_one">
					<div class="recommend_item animation_box" v-for="(item,index) in caipinxinxiRecomList" :key="index" @click="detailClick('caipinxinxi',item.id)">
			...
			<div class="newsList_view">
				<div class="newsList_title">健康饮食资讯</div>
