	...
	<div>
		<div class="app-contain">
			...
			<el-table
				...
				<el-table-column label="店铺图片" width="120" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						<div v-if="scope.row.dianputupian">
							<el-image v-if="scope.row.dianputupian.substring(0,4)=='http'" preview-teleported
								:preview-src-list="[scope.row.dianputupian.split(',')[0]]"
								:src="scope.row.dianputupian.split(',')[0]" style="width:100px;height:100px"></el-image>
							<el-image v-else preview-teleported
								:preview-src-list="[$config.url+scope.row.dianputupian.split(',')[0]]"
								:src="$config.url+scope.row.dianputupian.split(',')[0]" style="width:100px;height:100px">
							</el-image>
						</div>
						<div v-else>无图片</div>
					</template>
